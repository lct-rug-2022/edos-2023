...
def merge_configs(dataset_configs: List[Union[Dict, str]], parameters_config: Dict):
    """
    ...
    Parameters
    ----------
    dataset_configs: List[Union[Dict, str]]
        List of dataset configurations or paths to them.
    ...
    for dataset_config in dataset_configs:
        config_file_data = load_json(dataset_config) if isinstance(dataset_config, str) else dataset_config
