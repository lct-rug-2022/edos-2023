...
def _process_emoji_func(match_obj): return match_obj.expand(r'\g<1>').replace('_', ' ')
...
def preprocess(data: str, do_spaces: bool = True, do_hashtags: bool = True, do_masks: bool = True, do_emoji: bool = True):
    data = str(data)
    if do_masks:
